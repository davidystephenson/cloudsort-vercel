...
export default function undoChoice<ListItem extends Item> (props: {
  ...
  if (props.historyChoice.fresh) {
    ...
    const previousOperation = halfUndoneOperations.find(operation => operation.output[0] === props.historyChoice.newFirstOutput)
    ...
    props.historyChoice.operationId = previousOperation.mergeChoiceId
